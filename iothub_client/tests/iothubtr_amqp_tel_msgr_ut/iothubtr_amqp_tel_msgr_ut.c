...
static int TEST_create_amqp_message_data(IOTHUB_MESSAGE_HANDLE message_handle, BINARY_DATA* body_binary_data)
{
    (void)message_handle;
...
TEST_SUITE_INITIALIZE(TestClassInitialize)
{
    ...
    REGISTER_GLOBAL_MOCK_HOOK(create_amqp_message_data, TEST_create_amqp_message_data);
